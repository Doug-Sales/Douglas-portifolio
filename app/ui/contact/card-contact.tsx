export default function CardContact() {
  return (
    <div className="  flex-col border-2  border-gray-600 rounded-lg  ">

      <div className=" border-2 border-l-0 border-gray-600/50 rounded-lg flex items-center m-2   ">
        <span className="text-orange  w-16 h-16 rounded-lg text-center flex justify-center items-center bg-gray-600/50 text-2xl ">
          <svg stroke="currentColor" fill="currentColor" className="w-8  p-0.5 " strokeWidth="0" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg"><path d="M272 0H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h224c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zM160 480c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm112-108c0 6.6-5.4 12-12 12H60c-6.6 0-12-5.4-12-12V60c0-6.6 5.4-12 12-12h200c6.6 0 12 5.4 12 12v312z"></path></svg>
        </span>
      ...
      <div className="border-2 border-r-0 border-gray-600/50 rounded-lg flex items-center m-2 ">
        <div className="flex-col flex-1 text-center pl-2">
          <h6 className="font-medium dark:text-white">
            <p className="hover:text-[#FA5252] duration-300 transition" >
              Valinhos-SP
            </p>
        ...
        <span className="text-orange w-16 h-16 rounded-lg text-center flex justify-center items-center bg-gray-600/50 text-2xl ">
          <svg stroke="currentColor" className="w-10 " fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="border-2 border-l-0 border-gray-600/50 flex items-center m-2  rounded-lg">
        <span className="text-orange w-16 h-16 rounded-lg text-center flex justify-center items-center bg-gray-600/50 text-2xl ">
          <svg stroke="currentColor" fill="currentColor" className="w-8" strokeWidth="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
