export default function LinksNetwork() {
  return (
    <div className="w-full flex items-center justify-center space-x-12 " >
      <ul className="">
        <li title="LinkedIn" className="w-16 h-16 rounded-lg transition duration-300 ease-in-out hover:text-gray-200 text-[#0e76a8] text-center flex justify-center items-center bg-gray-600/50">
          <a href="https://www.linkedin.com/in/douglas-saless/" target="_blank">
            <svg className="w-12 h-12" viewBox="-143 145 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <ul>
        <li title="Hackerrank" className="w-16 h-16 text-[#32C766] transition duration-300 ease-in-out hover:text-gray-200 rounded-lg text-center flex justify-center items-center bg-gray-600/50">
          <a href="https://www.hackerrank.com/profile/douglasmsales28" target="_blank">
      ...
      <ul >
        <li title="GitHub" className="w-16 h-16 rounded-lg transition duration-300 ease-in-out hover:text-gray-200 text-[#f1502f] text-center flex justify-center items-center bg-gray-600/50">
          <a href="https://github.com/Doug-Sales" target="_blank">
            <svg className="w-12 h-12" viewBox="-143 145 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
              <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
